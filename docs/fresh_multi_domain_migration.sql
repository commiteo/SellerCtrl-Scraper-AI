-- Fresh Multi-Domain Scraping System Database Migration
-- This file creates new tables for multi-domain scraping from scratch
...
-- Table for storing multi-domain scraping history (INDIVIDUAL RESULTS)
CREATE TABLE multi_domain_scraping_history (
  ...
  image_url TEXT,
  product_url TEXT,
  data_source VARCHAR(50) DEFAULT 'main_page', -- main_page, buying_options, unavailable
...
-- Table for storing price comparison results (AGGREGATED DATA)
...
-- Table for storing multi-domain scraping batches (BATCH INFO)
